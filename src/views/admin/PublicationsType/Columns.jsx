            ...
            <Dialog>
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="bg-gray-800">
                        ...
                        <Link to={`/admin-dashboard/publicationstype/manage/${row.original.publicationsTypeId}`}>
                            <DropdownMenuItem>
                        ...
                        <Link to={`/admin-dashboard/publicationstype/manage/${row.original.publicationsTypeId}/?updatecall=true`} state={{ 'updatecall': true }}>
                            <DropdownMenuItem>
