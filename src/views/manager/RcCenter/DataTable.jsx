        ...
        <div>
            ...
            <div className="flex justify-between items-center py-4">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <Select onValueChange={(value) => table.setPageSize(Number(value))} name="role" id="role" className="inline-block px-4 py-2 text-white hover:text-white duration-150 font-medium bg-gray-800 rounded-fullhover:bg-gray-500 active:bg-gray-700 md:text-sm outline-none" value={table.getState().pagination.pageSize}>
